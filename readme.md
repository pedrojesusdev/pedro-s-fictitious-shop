...
Because ES Modules are used, the project must be served via a local server.
...
adaptar esse README para um tom mais corporativo

ou deixar ele mais estudante / portfólio

ou incluir screenshots e badges